...
class PycutTestCase(tests_base.BaseTestCase):
    ...
    def test_single_negative_field(self):
        value = 'some_file.json.00000'
        delimiter = '.'

        self.assertEqual('some_file', pycut.cut(value, '-2', delimiter))
        self.assertEqual('json', pycut.cut(value, '-1', delimiter))
    ...
    def test_field_range_negative(self):
    ...
    def test_field_segments_negative(self):
        ...
        self.assertEqual('some_file.ini.json', pycut.cut(value, '1:2,-1', delimiter))
